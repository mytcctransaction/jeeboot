...
import org.jeecg.activiti.base.text.Convert;
...
public class ProcessDefinitionService {
     ...
     * @return
     */
    public Page<org.jeecg.activiti.domain.ProcessDefinition> listProcessDefinition(org.jeecg.activiti.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<org.jeecg.activiti.domain.ProcessDefinition> list = new Page<>();
        ...
        List<org.jeecg.activiti.domain.ProcessDefinition> ls=new ArrayList<>();
        for (ProcessDefinition definition: processDefinitionList) {
            ProcessDefinitionEntityImpl entityImpl = (ProcessDefinitionEntityImpl) definition;
            org.jeecg.activiti.domain.ProcessDefinition entity = new org.jeecg.activiti.domain.ProcessDefinition();
