...
public class ProcessDefinitionService {
     ...
     * @return
     */
    public Page<org.jeecg.modules.flow.domain.ProcessDefinition> listProcessDefinition(org.jeecg.modules.flow.domain.ProcessDefinition processDefinition,Integer pageNo,Integer pageSize) {


        Page<org.jeecg.modules.flow.domain.ProcessDefinition> list = new Page<>();
        ...
        if (pageNo != null && pageSize != null) {
            processDefinitionList = processDefinitionQuery.listPage((pageNo.intValue()) * pageSize.intValue(), pageSize.intValue());
        ...
        List<org.jeecg.modules.flow.domain.ProcessDefinition> ls=new ArrayList<>();
        for (ProcessDefinition definition: processDefinitionList) {
            ProcessDefinitionEntityImpl entityImpl = (ProcessDefinitionEntityImpl) definition;
            org.jeecg.modules.flow.domain.ProcessDefinition entity = new org.jeecg.modules.flow.domain.ProcessDefinition();
