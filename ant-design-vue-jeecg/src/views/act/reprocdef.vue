  ...
  <div class="mod-reprocdef">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button  type="primary" @click="deployHandle()">部署流程文件</el-button>
...
<script>
  export default {
    ...
    methods: {
      ...
      deployHandle () {
        this.visible = true
        this.url = window._CONFIG['domianURL'] + `/act/reprocdef/deploy`
      },
      // 删除
      deleteHandle (deploymentId) {
        ...
        this.$confirm({
          content: `确定对[id=${deploymentIds.join(',')}]进行删除操作？`,
          onOk: () => {
            this.$http({
